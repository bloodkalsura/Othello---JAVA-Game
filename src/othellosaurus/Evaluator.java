...
public class Evaluator {
    public static final int MOBILITY_FACTOR = 10000;// weights for heuristics given number of pieces on the board
...
// current number of moves and the previous set of weights
    ...
    public static int mobility(Board b) {
        long opponentMoves = b.getMoves(b.opponent);return Utils.mobilityScore[Utils.bitCount(b.legalMoves)][Utils.bitCount(opponentMoves)];
    }
    /**
...
// check for empty spaces in each direction
    ...
    public static final int[][] SQUARE_SCORE =
            {{ 100, -10, 8, 6},
                    ...
                    { 6, -4, 4, 0}};
    /**
     * Returns the piece placement score of the current player minus the piece* placement score of the opponent. See SQUARE_SCORE for values.
     */
