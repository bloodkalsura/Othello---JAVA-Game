...
// stop evaluating if we're past our time limitNode.stopTime = startTime + maxTime;
...
// rest of the game: score printed so owning a corner is worth 1 point
            ...
            g.extendOutput(s);
// last search did no static evaluations so can stop searching// (the remainder of the game is solved)
