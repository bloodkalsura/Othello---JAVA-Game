...
public class Node {
    ...
    public static final int RECORD_MOVE_PLY = 4; public static int orderPly; // max ply at which to do move-ordering
...
// move ordering for better alpha-beta pruning performance
        Board[] children = null;
        int numChildren = 0; if(ply <= orderPly) {
...
// NegaScout search
            int childValue;
            if(ply <= negascoutPly && n > 1) { long l = nextBoard.legalMoves;
