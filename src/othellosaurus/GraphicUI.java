...
// Other weights found through hill climbing algorithm
    ...
    private final Agent blackBot =
            new Agent(new Evaluator(new int[][] {
                    ...
                    {51, -50, 62, 3, 595, 3184},
                    {33, -5, 66, 2, 384, 2777},
                    {44, 50, 163, 0, 443, 2568}, {13, 50, 66, 0, 121, 986},
                    {4, 50, 31, 0, 27, 192},
                    {8, 500, 77, 0, 36, 299}},
                    new int[] {0, 55, 56, 57, 58, 59, 60, 61, 62, 63}),
                    false, 100, 1);
    ...
    public GraphicUI() {
        ...
        computerOutput.setMinimumSize(new java.awt.Dimension(220, 480)); computerOutput.setPreferredSize(new java.awt.Dimension(220, 440));
        ...
        timeSlider.setPaintLabels(true); timeSlider.addChangeListener(this);
    ...
    public void printEval() {
        ...
        System.out.println("MOBILITY: " + m * Evaluator.mobility(gameBoard)); System.out.println("FRONTIER: " + m * Evaluator.frontier(gameBoard));
    ...
    public void paintSquares() {
        super.repaint();
        for(int x = 0; x < 8; x++) {
            for(int y = 0; y < 8; y++) { squares[x][y].repaint();
            }
        }
        super.repaint();
    }
...
// take back last move
            if(!gameHistory.isEmpty()) { gameBoard = gameHistory.pop();
                setText();
                paintSquares();
            }
...
// print out current board position as an array
    ...
    private class Square extends JPanel implements MouseListener {
        ...
        public Square(int x, int y) {
            this.x = x;
            this.y = y;
            setPreferredSize(new Dimension(SQUARE_LENGTH, SQUARE_LENGTH)); setBackground(new Color(25, 140, 50));
